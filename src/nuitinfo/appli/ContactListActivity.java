...
public class ContactListActivity extends ListActivity {
	...
	public void onCreate(Bundle icicle) {
		...
		List<Map<String, String>> listItem = getListAmis(user_id, access_token);
		SimpleAdapter adapter = new SimpleAdapter(
				ContactListActivity.this.getBaseContext(), listItem,
				R.layout.itemami, new String[] { "img", "nom" }, new int[] {
						R.id.img, R.id.nomPrenom });
	...
	public List<Map<String, String>> getListAmis(int userid, String access_token) {
		List<Map<String, String>> returnedList = null;
