 ...
 * 
 */
public class RL extends ListActivity implements Runnable {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			SimpleAdapter mSchedule = new SimpleAdapter(
					RL.this.getBaseContext(), listItem, R.layout.itemami,
					new String[] { "img", "nom" }, new int[] { R.id.img,
							R.id.nomPrenom });

			// On attribue � notre listView l'adapter que l'on vient de
			// cr�er
			...
			maListViewPerso.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> a, View v, int position,
					...
					Intent i = new Intent(v.getContext(), CategoryChoiceActivity.class);
	...
	public ArrayList<Map<String, String>> getListAmis(int userid,
			String access_token) {
		ArrayList<Map<String, String>> returnedList = null;
		...
		try {
			...
			URI uri = URIUtils.createURI("http", "www.floriandubois.com", -1,
					"nuitinfo/facebook/getFriendList.php", "user_id=" + userid
			...
			returnedList = new ArrayList<Map<String, String>>();
			for (int i = 0; i < friendList.length(); ++i) {
				JSONObject friend = friendList.getJSONObject(i);
				Contact ami = new Contact(friend.getInt("id"),
						friend.getString("name"));
				returnedList.add(ami.getMap());
			}
		} catch (Exception e) {
